...
class Question4 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val startQuestionsButton = view.findViewById<Button>(R.id.next_button4)
    ...
    private fun setupButtonListeners() {
        val buttonIds = listOf(R.id.yesButton4, R.id.noButton4)
        buttonIds.forEach { id ->
            view?.findViewById<Button>(id)?.let { button ->
                button.setOnClickListener { buttonView ->
                    ...
                    // 선택된 상태에 따라 데이터 저장
                    val isYesButton = id == R.id.yesButton4
